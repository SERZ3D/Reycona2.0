...
{
    public partial class AnimalesRegistrados : Form
    {
        ...
        private void btnDatosPropietario_Click(object sender, EventArgs e)
        {
            PropietariosAnimal propietariosAnimal = new PropietariosAnimal();
            propietariosAnimal.Show();
            this.Hide();
        }
    }
}
